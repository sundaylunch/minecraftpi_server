...
def CreateLandscape(x,y,z,islandwidth,moatwidth,moatdepth):
  ...
  # Create water moat
  print("Placed water from: {},{},{} to {},{},{}".format(x-totalSize, y-1, z-totalSize, x+totalSize, y-moatdepth-1, z+totalSize))
  ...
  # Create island
  print("Placed island from: {},{},{} to {},{},{}".format(x-islandwidth, y, z-islandwidth, x+islandwidth, y-moatdepth, z+islandwidth))
